    ...
    <div class="w-75 mx-auto my-3">
        <div class="modal-content p-3">
            ...
            <div class="row mb-3 info-text">
                <div class="col-md-6">
                    <p class="mb-1"><strong>Expense Date:</strong> {{$data->invoice_date}}</p>
                    <p class="mb-0"><strong>Invoice No:</strong> {{$data->invoice_no}}</p>
                </div>
                <div class="col-md-6 text-end">
                    <p class="mb-0"><strong>Student Name:</strong> {{$data->student_name}}</p>
                    <p class="mb-0"><strong>Class Name:</strong> {{$data->class}}</p>
                    <p class="mb-0"><strong>Admission No:</strong> {{$data->admission_no}}</p>
                </div>
            </div>
