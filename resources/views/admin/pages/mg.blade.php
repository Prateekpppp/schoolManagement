                        ...
                        <form class="new-added-form">
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>MG No. </label>
                                    <input name="mg_no" type="text" placeholder="" class="form-control required" value="{{isset($data->mg_no) ? $data->mg_no : 'MG_'.substr(time(),5)}}">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>MG Application Date *</label>
                                    ...
                                    @foreach ($tcList as $key=>$job)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn fw-btn-fill btn-gradient-yellow !max-w-min" href="{{route('admin.pages.printMg', ['mg_no'=>$job->mg_no])}}">Print</a>
                                                <a class="btn fw-btn-fill btn-gradient-yellow !max-w-min" href="{{route('admin.pages.mg', ['mg_no'=>$job->mg_no])}}">Edit</a>
                                                <a class="btn fw-btn-fill btn-gradient-yellow !max-w-min !bg-red-700" data-model="MigrationCertificate" href="{{route('admin.post.updateStatus', ['id'=>$job->mg_id, 'status'=>0])}}">Remove</a>
                                                </div>
                                            </td>
                                        </tr>
...
<script>
    ...
    function submitForm(form){
        ...
        callAjaxFormData('post',"{{route('admin.post.createMg')}}",data,ajaxResponseModal);
    }
