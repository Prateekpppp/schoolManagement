                                ...
                                <tbody class="tdata">
                                    ...
                                    @foreach ($classes as $key=>$job)
                                        <tr>
                                            ...
                                            {{-- <td>{{$key}}</td> --}}
                                            <td data-id="{{$key}}">
                                                <a subject_id="{{$subject->id}}" class_id="{{$key}}" class="remove_cSection" href="javascript:void(0)">Remove</a>
                                            </td>
                                        </tr>
...
<script>
    ...
    $('.remove_cSection').on('click', function(){
        data = {};
        data['subject_id'] = $(this).attr('subject_id');
        data['class_id'] = $(this).attr('class_id');
        callApi('post',"{{route('admin.post.removeClass')}}",data,ajaxResponseModal);
    });
