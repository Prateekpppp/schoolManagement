    ...
    <div class="w-75 mx-auto my-3">
        <div class="modal-content p-3">
            ...
            <div class="row mb-3 info-text">
                <div class="col-md-6">
                    <p class="mb-1"><strong>Salary Date:</strong> {{$data->salary_date}}</p>
                    {{-- <p class="mb-0"><strong>Invoice No:</strong> INV{{substr(strtotime($data->salary_date), -4)}}</p> --}}
                </div>
                <div class="col-md-6 text-end">
                    <p class="mb-0"><strong>Staff Name:</strong> {{$data->name}}</p>
                </div>
            </div>
