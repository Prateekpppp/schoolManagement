                ...
                <div class="card height-auto">
                    <div class="card-body">
                        <div class="heading-layout1">
                            ...
                            <div>
                                <a href="{{route('admin.pages.addVehicle')}}" class="btn fw-btn-fill btn-gradient-yellow !max-w-min">Add Vehicle</a>
                            </div>
                            <div class="dropdown">
                                ...
                                <tbody class="tdata">
                                    ...
                                    @foreach ($data as $key=>$job)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn fw-btn-fill btn-gradient-yellow !max-w-min" href="{{route('admin.pages.updateVehicle', ['id' => $job->id])}}">Edit</a>
                                                <a href="javascript:void(0)" data-model="Vehicle" data-id="{{$job->id}}" class="delete btn fw-btn-fill btn-gradient-yellow !bg-red-700 !max-w-min" href="javascript:void(0)">Remove</a>
                                            </td>
                                        </tr>
