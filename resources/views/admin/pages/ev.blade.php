                    ...
                    <div class="card-body"> 
                        <div class="heading-layout1">
                            <div class="item-title">
                                <h3>Generate Event Certificate</h3>
                            </div>
                            <div class="dropdown">
                        ...
                        <form class="new-added-form">
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input name="ev_no" type="text" placeholder="" class="form-control required" value="{{isset($data->ev_no) ? $data->ev_no : 'EV_'.substr(time(),5)}}">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    @foreach ($tcList as $key=>$job)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn fw-btn-fill btn-gradient-yellow !max-w-min" href="{{route('admin.pages.printEv', ['ev_no'=>$job->ev_no])}}">Print</a>
                                                <a class="btn fw-btn-fill btn-gradient-yellow !max-w-min" href="{{route('admin.pages.ev', ['ev_no'=>$job->ev_no])}}">Edit</a>
                                                <a class="btn fw-btn-fill btn-gradient-yellow !max-w-min !bg-red-700" data-model="EventCertificate" href="{{route('admin.post.updateStatus', ['id'=>$job->ev_id, 'status'=>0])}}">Remove</a>
                                                </div>
                                            </td>
                                        </tr>
