                                ...
                                <tbody class="tdata">
                                    ...
                                    @foreach ($data as $key=>$job)
                                        <tr>
                                            ...
                                            <td>
                                                @if($job->upload)
                                                <a href="{{asset('/').$job->upload}}" download>Download</a>
                                                @else
                                                N/A
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                <div class="flex flex-row gap-2">
                                                    <a href="{{route('admin.pages.updateStudentHomework', ['id' => $job->id])}}" class="btn fw-btn-fill btn-gradient-yellow !max-w-min">Edit</a>
