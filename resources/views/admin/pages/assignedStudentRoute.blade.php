                    ...
                    <div class="card-body">
                        <div class="heading-layout1">
                            <div class="item-title">
                                <h3>All Student Transport</h3>
                            </div>
                            <div>
                                <a href="{{route('admin.pages.assignStudentRoute')}}" class="btn fw-btn-fill btn-gradient-yellow !max-w-min">Assign Student Route</a>
                            </div>
                            <div class="dropdown">
                                    ...
                                    @foreach ($data as $key=>$job)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:void(0)" data-model="StudentRoute" data-id="{{$job->id}}" class="delete btn fw-btn-fill btn-gradient-yellow !bg-red-700 !max-w-min" href="javascript:void(0)">Remove</a>
                                            </td>
                                        </tr>
