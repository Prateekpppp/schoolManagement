                ...
                <div class="card height-auto">
                    <div class="card-body">
                        <div class="heading-layout1">
                            ...
                            <div class="">
                                <a href="{{route('admin.pages.assignedRouteVehicle')}}" class="btn fw-btn-fill btn-gradient-yellow !max-w-min" href="javascript:void(0)">View All</a>
                            </div>
                            <div class="dropdown">
                        ...
                        <form class="new-added-form">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Driver </label>
                                    <select name="driver_id" class="select2 required">
                                        <option value="">Please Select Driver *</option>
                                        @foreach($drivers as $driver)
                                            <option {{isset($data) && $data->driver_id == $driver->id ? 'selected' : ''}} value="{{$driver->id}}">{{$driver->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
...
<script>
    ...
    function submitForm(form){
        ...
        callAjaxFormData('post',"{{route('admin.post.assignRouteVehicleDriver')}}",data,ajaxResponseModal);
    }
