                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <select name="student_id" class="select2 required">
                                        ...
                                        @foreach($students as $class)
                                            <option value="{{$class->id}}" {{isset($data->student_id) && $data->student_id == $class->id ? 'selected' : ''}}>{{$class->admission_no}} | {{$class->roll_no}} | {{$class->name}} | {{$class->class}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <select name="ncc" class="select2 required">
                                        <option {{isset($data) && $data->ncc == '0' ? 'selected' : ''}} value="0">No</option>
                                        <option {{isset($data) && $data->ncc == '1' ? 'selected' : ''}} value="1">Yes</option>
                                    </select>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Games Played Or Extra Activity *</label>
                                    <select name="game_played" class="select2 required">
                                        <option {{isset($data) && $data->game_played == '0' ? 'selected' : ''}} value="0">No</option>
                                        <option {{isset($data) && $data->game_played == '1' ? 'selected' : ''}} value="1">Yes</option>
                                    </select>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Fees Dues if Any  *</label>
                                    <input name="feedue" type="text" class="form-control">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Any Conecession  *</label>
                                    <input name="concession" type="text" class="form-control required">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Failed in Previous Classes *</label>
                                    <select name="failed_last_class" class="select2 required">
                                        <option {{isset($data) && $data->failed_last_class == '0' ? 'selected' : ''}} value="0">No</option>
                                        <option {{isset($data) && $data->failed_last_class == '1' ? 'selected' : ''}} value="1">Yes</option>
                                    </select>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input name="behaviour" type="text" class="form-control required">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input name="nationality" type="text" class="form-control" value="Indian">
                                </div>
                                    ...
                                    @foreach ($tcList as $key=>$job)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                {{-- <a class="btn fw-btn-fill btn-gradient-yellow !max-w-min" href="{{route('admin.pages.tc', ['tc_no'=>$job->tc_no])}}">Print</a> --}}
                                                <a class="btn fw-btn-fill btn-gradient-yellow !max-w-min" href="{{route('admin.pages.tc', ['tc_no'=>$job->tc_no])}}">Edit</a>
                                                <a class="btn fw-btn-fill btn-gradient-yellow !max-w-min !bg-red-700" href="{{route('admin.post.updateStatus', ['id'=>$job->tc_id, 'status'=>0])}}">Remove</a>
                                                </div>
                                            </td>
                                        </tr>
