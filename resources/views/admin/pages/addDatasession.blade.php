                ...
                <div class="card height-auto">
                    <div class="card-body">
                        <div class="heading-layout1">
                            ...
                            <div class="">
                                <a href="{{route('admin.pages.dataSession')}}" class="btn fw-btn-fill btn-gradient-yellow !max-w-min" href="javascript:void(0)">View All</a>
                            </div>
                            <div class="dropdown">
...
<script>
    ...
    function submitForm(form){
        ...
        callAjaxFormData('post',"{{route('admin.post.createDatasession')}}",data,ajaxResponseModal);
    }
