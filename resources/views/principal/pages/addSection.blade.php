                ...
                <div class="card height-auto">
                    <div class="card-body">
                        <div class="heading-layout1">
                            ...
                            <div class="">
                                <a href="{{route('admin.pages.section')}}" class="btn fw-btn-fill btn-gradient-yellow !max-w-min" href="javascript:void(0)">View All</a>
                            </div>
                            <div class="dropdown">
                        ...
                        <form class="new-added-form">
                            ...
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input value="{{(isset($classSection) && !is_null($classSection)) ? $classSection->section_name : ''}}" name="section" type="text" placeholder="" class="form-control required">
                                </div>
